...
"}")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_4.setText(QCoreApplication.translate("MainWindow", u"Can you now understand me? Well, let's jump right in!", None))
        self.pushButton.setText("")
        self.label_5.setText(QCoreApplication.translate("MainWindow", u"Where should we install Vega?", None))
        self.label_6.setText(QCoreApplication.translate("MainWindow", u"Please, select a valid path to the folder you want us to install Vega", None))
