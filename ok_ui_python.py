...
class Ui_MainWindow(QMainWindow):
    ...
    def setupUi(self, MainWindow):
        ...
        self.topbar.setStyleSheet(u"background-color: rgb(34, 37, 44);\n"
                                  "border-radius: 10px;\n"
                                  "")
        ...
        sizePolicy3.setHeightForWidth(self.name_container.sizePolicy().hasHeightForWidth())
        self.name_container.setSizePolicy(sizePolicy3)
        ...
        self.label.setStyleSheet(u"image: url(:/icon/res/icons/Feather_white/user.svg);")
        ...
        sizePolicy3.setHeightForWidth(self.UI_usernameLabel.sizePolicy().hasHeightForWidth())
        self.UI_usernameLabel.setSizePolicy(sizePolicy3)
        font1 = QFont()
        ...
        self.scrollAreaWidgetContents.setGeometry(QRect(0, 0, 207, 537))
        ...
        self.pushButton.setStyleSheet(u"QPushButton{\n"
                                      ...
                                      "}")
        icon = QIcon()
        icon.addFile(u":/icon/res/icons/Feather_white/user.svg", QSize(), QIcon.Normal, QIcon.Off)
        ...
        self.pushButton_2.setStyleSheet(u"QPushButton{\n"
                                        ...
                                        "}")
        icon1 = QIcon()
        icon1.addFile(u":/icon/res/icons/Feather_white/link.svg", QSize(), QIcon.Normal, QIcon.Off)
        ...
        self.pushButton_3.setStyleSheet(u"QPushButton{\n"
                                        ...
                                        "}")
        icon2 = QIcon()
        icon2.addFile(u":/icon/res/icons/Feather_white/settings.svg", QSize(), QIcon.Normal, QIcon.Off)
        ...
        self.graphicsView = QGraphicsView(self.Blueprint)
